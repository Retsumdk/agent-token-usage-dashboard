...
program.name("agent-token-usage-dashboard").description("Visual dashboard data generator for tracking token consumption across multiple agents and models").version("1.0.0")
